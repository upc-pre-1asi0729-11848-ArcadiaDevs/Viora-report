...
A continuación, se detalla la pauta de secuencias (timing) del contenido del video, estructurada de la siguiente manera:

* **00:00:00 – 00:00:35 | Introducción del equipo**
  * **Presentador:** Víctor Paredes.
  * **Contenido:** Presentación de ArcadiaDevs y sus integrantes (Víctor Paredes, Fabrizio Santi, Piero Espada, Jahat Trinidad y Josué Carpio). Introducción a Viora como plataforma AgTech para productores y especialistas.

* **00:00:35 – 00:02:00 | Proceso de trabajo y organización**
  * **Presentador:** Fabrizio Santi.
  * **Contenido:** Descripción de la metodología ágil por sprints, organización del Product Backlog, y uso de herramientas (Trello, GitHub, Figma, Swagger). Enfoque en la coherencia entre investigación, diseño e implementación.

* **00:02:00 – 00:08:20 | Testimonios del equipo y desarrollo de competencias**
  * **00:02:00 – 00:03:00 | Víctor Paredes:** Aporte en la arquitectura lógica, buenas prácticas, *bounded contexts* y visión integral de Viora.
  * **00:03:00 – 00:04:00 | Piero Espada:** Aporte en análisis funcional, validación (QA) y consolidación de información para métricas.
  * **00:04:00 – 00:05:00 | Jahat Trinidad:** Aporte en DevOps, despliegue en la nube, infraestructura técnica y flujos de GitFlow.
  * **00:05:00 – 00:06:00 | Fabrizio Santi:** Aporte en la gestión ágil mediante Trello, definición de Historias de Usuario y estructuración del Sprint Backlog.
  * **00:06:00 – 00:07:20 | Josué Carpio:** Aporte en el soporte de implementación, validación de flujos y coherencia en la integración frontend-backend.

* **00:07:20 – 00:08:00 | Cierre y reflexiones finales**
  * **Presentador:** Víctor Paredes.
  * **Contenido:** Reflexiones sobre el crecimiento del equipo, liderazgo compartido y el valor entregado al sector agrícola con visión de mejora continua.

Para respaldar visualmente el contenido, a continuación se adjunta un cuadro representativo (escena) extraído del desarrollo del video:

\begin{figure}[H]
\caption{Cuadro representativo del video About-The-Team.}
\centering
\includegraphics[width=0.8\textwidth]{report/assets/sprint-evidence/sprint-4/about-the-team.png}
